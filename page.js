...
/*   import Example from "./filter/page"; */
  ...
  return (
    <div>
        <div className="h-screen bg-gradient-to-b from-yellow-500  to-white">
          <header className=" bg-gray-800 text-white ml-48 mr-48 rounded-b-3xl cu">
           
           <nav className="container mx-auto p-4 pt-4">
              <ul className="flex justify-center space-x-8">
                <li><Link href={`/categories`} className="hover:text-orange-600 delay-200">Best Sellers</Link></li>
                <li><Link href={`/giftIdeas`} className="hover:text-orange-600 delay-200">Gift Ideas</Link></li>
                <li><Link href="#" className="hover:text-orange-600 delay-200">New Releases</Link></li>
                <li><Link href={`/filter`} className="hover:text-orange-600 delay-200">filter</Link></li>
          ...
          <div className="flex mt-10 ml-80">
              <select className="ml-36  bg-slate-800 text-white py-2 px-4 rounded-l mr-32">
            <option className="bg-slate-800 text-white ">All Category</option>
              <option value="fashion" className="bg-slate-800 text-white">Action</option>
              <option value="electronics"className="bg-slate-800 text-white">another action</option>
              <option value="fashion"className="bg-slate-800 text-white">Something else here</option>
            </select>
            ...
            <select className="ml-20 bg-slate-800 text-white py-2 px-4 rounded-l mr-32">
            <option  >English</option>
              <option value="fashion">France</option>
            </select>
          </div>
          {/* cotnes leptopis qvemot  */}
    ...
    <nav className="flex justify-center space-x-6 mb-4 text-gray-400">
